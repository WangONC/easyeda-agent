...
type drcBaseline struct {
	...
	Report   drcFlatReport `json:"report"`
}
...
func drcFindingKey(v drcFlatViolation) (string, bool) {
...
func compareDRC(a, b drcBaseline) map[string]any {
	out := map[string]any{"comparable": false, "new": []drcFlatViolation{}, "cleared": []drcFlatViolation{}, "persistent": []drcFlatViolation{}}
	...
	buckets := map[string][]drcFlatViolation{}
	...
	added, persistent, cleared := []drcFlatViolation{}, []drcFlatViolation{}, []drcFlatViolation{}
	for _, v := range b.Report.Violations {
		k, _ := drcFindingKey(v)
		if len(buckets[k]) > 0 {
