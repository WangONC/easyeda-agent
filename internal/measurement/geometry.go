...
func Geometry(s fastpath.Snapshot, nets []string, paths []Path) []map[string]any {
	out := []map[string]any{}
...
func Annotate(result, p map[string]any) error {
...
func PathMatchesProfile(s fastpath.Snapshot, paths []Path, net string, profile fastpath.RoutingProfile) bool {
	ids := map[string]bool{}
